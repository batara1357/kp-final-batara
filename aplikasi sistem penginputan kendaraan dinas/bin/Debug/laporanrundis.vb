...
Public Class laporanrundis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_sistem_penginputan_kendaraan_dinas.laporanrundis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporanrundis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporanrundis = New laporanrundis()
        rpt.Site = Me.Site
        Return rpt
    End Function
