...
Public Class cetakrundis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_sistem_penginputan_kendaraan_dinas.cetakrundis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcetakrundis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cetakrundis = New cetakrundis()
        rpt.Site = Me.Site
        Return rpt
    End Function
