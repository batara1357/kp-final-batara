...
Public Class cetakaslog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_sistem_penginputan_kendaraan_dinas.cetakaslog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcetakaslog
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cetakaslog = New cetakaslog()
        rpt.Site = Me.Site
        Return rpt
    End Function
